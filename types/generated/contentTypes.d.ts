...
export interface ApiTourHighlightTourHighlight
  ...
  info: {
    ...
    displayName: 'Tour Highlight';
    pluralName: 'tour-highlights';
    singularName: 'tour-highlight';
  };
  options: {
    draftAndPublish: true;
  };
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::tour-highlight.tour-highlight'
    > &
      Schema.Attribute.Private;
    order: Schema.Attribute.Integer & Schema.Attribute.DefaultTo<0>;
    publishedAt: Schema.Attribute.DateTime;
...
export interface ApiTourInclusionTourInclusion
  extends Struct.CollectionTypeSchema {
  collectionName: 'tour_inclusions';
  info: {
    description: "What's included in the tour";
    displayName: 'Tour Inclusion';
    pluralName: 'tour-inclusions';
    singularName: 'tour-inclusion';
  };
  options: {
    draftAndPublish: true;
  };
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::tour-inclusion.tour-inclusion'
    > &
      Schema.Attribute.Private;
    order: Schema.Attribute.Integer & Schema.Attribute.DefaultTo<0>;
    publishedAt: Schema.Attribute.DateTime;
...
export interface ApiTourItineraryTourItinerary
  extends Struct.CollectionTypeSchema {
  collectionName: 'tour_itineraries';
  info: {
    description: 'Daily itinerary for tours';
    displayName: 'Tour Itinerary';
    pluralName: 'tour-itineraries';
    singularName: 'tour-itinerary';
  };
  options: {
    draftAndPublish: true;
  };
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::tour-itinerary.tour-itinerary'
    > &
      Schema.Attribute.Private;
    meals: Schema.Attribute.String & Schema.Attribute.Required;
    order: Schema.Attribute.Integer & Schema.Attribute.DefaultTo<0>;
    publishedAt: Schema.Attribute.DateTime;
    run: Schema.Attribute.String & Schema.Attribute.Required;
    tour: Schema.Attribute.Relation<'manyToOne', 'api::tour.tour'>;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
...
export interface ApiTourTour extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Traverse Active Stays Tours';
    displayName: 'Tour';
    pluralName: 'tours';
    singularName: 'tour';
  };
